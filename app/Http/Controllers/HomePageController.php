...
class HomePageController extends Controller
{
    public function index()
    {
        ...
        return view('Homepage.Accueil', compact('medicalTypes', 'companyTypes', 'doctors'));
    }
    ...
    public function showMedicalType(Request $request)
    {
        ...
        return view('Homepage.healthmeds', compact('medicalTeams'));
    }

    public function showcompany()
    {
        $companies = Company::all();
        return view('Homepage.companies', compact('companies'));
    }
    ...
    public function showcompanies(Request $request)
    {
        ...
        $query->whereHas('address.city', function ($query) use ($searchLocation) {
