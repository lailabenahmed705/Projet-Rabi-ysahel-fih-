  ...
  <div class="dc-innerbanner-holder dc-haslayout dc-open dc-opensearchs ">
            ...
            <div class="row">
              <div id="dc-twocolumns" class="dc-twocolumns dc-haslayout">
                        ...
                        <figure class="dc-docsingleimg">
                          @if(!empty($pharmacy->user->profile_photo_path))
                          <img width="" height="" class="dc-image-res" src="{{ asset('storage/' . $pharmacy->user->profile_photo_path) }}"  alt="{{ $pharmacy->establishment_name }}">
                      @else
                          <img class="dc-ava-detail" src="{{ asset('assets/img/avatars/avatarhel.jpg') }}" alt="{{ $pharmacy->establishment_name }}">
                      @endif
                       </figure>
                    <div class="dc-docsingle-content">
                      <div class="dc-title">
							          <h2>
                          <a href="">{{ $pharmacy->establishment_name }} </a>
                          ...
                          <span>
                            ...
                            {{ $pharmacy->nbre_feedbacks }} feedbacks
                        </span>
                      </li>
                        <li>
                        <p><i class="fas fa-calendar-alt"></i> {{ $pharmacy->experience }} years of experience and hardwork</p></li>
                      </ul>
                    <div class="dc-btnarea">
                        ...
                        <div class="modal-body">
                          ...
                          <form action="{{ route('feedback.store') }}" method="POST" style="display: flex; flex-direction: column;">
                            ...
                            <div style="display: flex; align-items: center;">
                                <input name="staff_attendee_id" id="staffAttendeeId" value="{{ $pharmacy->user->id }}" style="margin-right: 10px;">
    ...
    <div class="dc-userdetails-holder active tab-pane" id="userdetails">
        ...
        <div class="dc-description">
          <p><span>responsible: {{ $pharmacy->responsible_name }}</span></p>
          <p><span><i class="fas fa-map-marker-alt"></i>{{ $pharmacy->address_complete }}</span></p>
          <p><i class="fas fa-phone"></i>{{ $pharmacy->phoneNumber }}</p>
          <p><i class="fas fa-envelope"></i>{{ $pharmacy->email }}</p>
          <p>{{ $pharmacy->professional_bio }}</p>
        </div>
    </div>
  </div>
<div class="dc-education-holder dc-aboutinfo">
  ...
  <ul class="dc-expandedu">
    <li class=""> <div class="dc-subpaneltitle"><span><em></em>	Starting at : 			</span><em>{{ $pharmacy->start_time }}</em>							</div></li>
    <li class=""><div class="dc-subpaneltitle"><span><em></em> ending at : 	</span><em>	{{ $pharmacy->end_time }}</em>						</div></li>
    <li class=""><div class="dc-subpaneltitle"><span>working days :  <em></em>	</span><em>{{ $pharmacy->workdays }}</em></div></li>
  </ul>
</div>
...
<div class="dc-education-holder dc-aboutinfo">
  ...
  <ul class="dc-expandedu">
    <li class=""> <div class="dc-subpaneltitle"><span><em></em>			</span><em>{{ $pharmacy->education }}</em>							</div></li>
    <li class=""><div class="dc-subpaneltitle"><span><em></em> 	</span><em>	{{ $pharmacy->education }}</em>						</div></li>
  </ul>
</div>
<div class="dc-education-holder dc-aboutinfo">
  ...
  <ul class="dc-expandedu">
    <li class=""> <div class="dc-subpaneltitle"><span><em></em>	 			</span><em>{{ $pharmacy->certificates }}</em>							</div></li>
    <li class=""><div class="dc-subpaneltitle"><span><em></em>  	</span><em>	{{ $pharmacy->education }}</em>						</div></li>
  </ul>
</div>
  @php
  $feedbacks = \App\Models\Feedback::where('staff_attendee_id', $pharmacy->user->id)->get();
  @endphp
