...
<main id="dc-main" class="dc-main dc-haslayout">
                ...
                <div class="dc-searchresult-holder">
                    ...
                    @if ( $companies->count() > 0)
                        <div class="dc-searchresult-head">
                            <div class="dc-title">
                                <h4><strong>{{ $companies->count() }}</strong>&nbsp;matches found</h4>
                            </div>
                            ...
                            <div class="dc-searchresult-grid dc-searchresult-list dc-searchvlistvtwo">
                                ...
                                @php
                                $image = isset($company->user->profile_photo_path )
                                ? $company->user->profile_photo_path
    ...
    <li><em>{{ $company->company_type }}</em></li>
    <div class="dc-tags">
        <ul>
            <ul class="dc-docinfo">
            </ul>
    ...
    <div class="dc-doclocation dc-doclocationvtwo">
        @if($company->companyaddress && $company->companyaddress->state_id)
            @php
                $state = \App\Models\State::find($company->companyaddress->state_id);
                $dependency = \App\Models\Dependency::find($company->companyaddress->dependency_id);
            @endphp
        ...
        @if($company->companyaddress)
            <a href="{{ $company->companyaddress->address_complete ?? '' }}" class="dc-btn">Get IT On Map</a>
        @else
            <a href="#" class="dc-btn">Get IT On Map</a>
        @endif
</div>
