...
<form method="post" action="{{ route('specandserv') }}">
    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-10 col-xl-8">
        <div class="dc-dashboardbox dc-offered-holder">
            ...
            @php
                $chosenServiceIds = Modules\Service\app\Models\ChosenService::where('medical_team_id', $user->medicalteam->id)->pluck('service_category_id');
                $serviceCategories = Modules\Service\app\Models\ServiceCategory::whereIn('id', $chosenServiceIds)->get();
