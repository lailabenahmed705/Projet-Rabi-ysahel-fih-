...
@php
     $user = auth()->user();
    $appointments = Modules\Appointments\App\models\Appointment::where('staff_attendee_id', $user->medicalTeam->id)->get();
          ...
          <div class="dc-user-profile">
              <div class="dc-dashboardbox dc-dashboardtabsholder">
                  ...
                  <tbody>
                    ...
                    @php
                      $city_name = Modules\International\App\Models\City::find($appointment->city_id)->name;
                      $servicecategories = Modules\Service\App\Models\ServiceCategory::find($appointment->service_category_id)->name;
                    @endphp
                    <tr>
