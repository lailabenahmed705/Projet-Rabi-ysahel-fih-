...
">
                                ...
                                {{--    <div class="dc-location dc-tabsinfo">
                                    <div class="dc-tabscontenttitle">
                                        <h3>Your Dependency</h3>
                                    </div>
                                    <div class="dc-formtheme dc-userform">
                                        <fieldset>
                                            <div class="form-group toolip-wrapo">
                                                <label for="dependency_id">Select your dependency:</label>
                                                <select name="dependency_id" id="dependency_id" class="form-control" style="
    height: 51px;
">
                                                    <option value="" selected disabled>Select your dependency</option>
                                                    @php
                                                    $dependencies = Modues\International\app\Models\Dependency::where('status', 'active')->get();
                                    ...
                                    <div class="dc-formtheme dc-userform">
                                        <fieldset>
                                            <div class="form-group toolip-wrapo">
                                                ...
                                                <select name="city_id" id="city_id" class="form-control" style="
    height: 51px;
">
