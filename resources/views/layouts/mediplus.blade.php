...
<head>
								...
								<div class="main-menu">
									<nav class="navigation">
										<ul class="nav menu">
											...
											<li><a href="#">vous etes soignant? <i class="icofont-rounded-down"></i></a>
    ...
    <a href="{{ url('/auth/login-basic') }}" class="btn btn-primary text-white ms-2">Se connecter</a>
...
<section class="search-area py-5" style="background: #f4f8fb;">
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="text-center mb-4">
                    <h2>Find Medical Personnel</h2>
                    <p>Search for doctors, specialists, or medical teams by category</p>
                </div>
                <form action="{{ route('search') }}" method="GET">
                    <div class="input-group">
                        <input type="text" name="search_category" class="form-control" placeholder="Enter specialty or medical type (e.g. cardiologist, pediatrician)" required>
...
<!-- End Search Section -->
				...
				<!-- Start Single Slider -->
				<div class="single-slider" style="background-image:url('{{ asset('assets/img/mediplus/slider.jpg') }}')">
					<div class="container">
						<div class="row">
							<div class="col-lg-7">
								<div class="text">
				...
				<!-- Start End Slider -->
				<!-- Start Single Slider -->
				<div class="single-slider" style="background-image:url('{{ asset('assets/img/mediplus/slider3.jpg') }}')">
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="section-title">
							...
							<img src="{{ asset('assets/img/mediplus/section-img.png') }}" alt="#">
    ...
    <div class="row">
        <div class="col-lg-12 col-12">
            <div class="owl-carousel portfolio-slider">
                <div class="single-pf">
                    <img src="{{ asset('assets/img/mediplus/pf1.jpg') }}" alt="Portfolio Image 1">
                    <a href="#" class="btn">View Details</a>
                </div>
                <div class="single-pf">
                    <img src="{{ asset('assets/img/mediplus/pf2.jpg') }}" alt="Portfolio Image 2">
                    <a href="#" class="btn">View Details</a>
                </div>
                <div class="single-pf">
                    <img src="{{ asset('assets/img/mediplus/pf3.jpg') }}" alt="Portfolio Image 3">
                    <a href="#" class="btn">View Details</a>
                </div>
                <div class="single-pf">
                    <img src="{{ asset('assets/img/mediplus/pf4.jpg') }}" alt="Portfolio Image 4">
                    <a href="#" class="btn">View Details</a>
                </div>
                <div class="single-pf">
                    <img src="{{ asset('assets/img/mediplus/pf1.jpg') }}" alt="Portfolio Image 1">
				...
				<div class="row">
					<div class="col-lg-12">
						<div class="section-title">
							...
							<img src="{{ asset('assets/img/mediplus/section-img.png') }}" alt="Section Image">
							<p>Lorem ipsum dolor sit amet consectetur adipiscing elit praesent aliquet. pretiumts</p>
						</div>
					</div>
				</div>
				...
				<div class="row">
					<div class="col-lg-4 col-md-6 col-12">
						...
						<div class="single-news">
							<div class="news-head">
							<img src="{{ asset('assets/img/mediplus/blog1.jpg') }}" alt="Blog Image 1">
							</div>
							<div class="news-body">
					...
					<div class="col-lg-4 col-md-6 col-12">
						...
						<div class="single-news">
							<div class="news-head">
							<img src="{{ asset('assets/img/mediplus/blog2.jpg') }}" alt="Blog Image 2">
							</div>
							<div class="news-body">
								<div class="news-content">
					...
					<div class="col-lg-4 col-md-6 col-12">
						...
						<div class="single-news">
							<div class="news-head">
							<img src="{{ asset('assets/img/mediplus/blog3.jpg') }}" alt="Blog Image 2">
							</div>
							<div class="news-body">
								<div class="news-content">
			...
			<div class="container">
				<div class="row">
					<div class="col-lg-12 col-md-12 col-12">
                        ...
                        <img src="{{ asset('assets/img/mediplus/client1.png') }}" alt="Client 1">
                    </div>
                    <div class="single-clients">
                        <img src="{{ asset('assets/img/mediplus/client2.png') }}" alt="Client 2">
                    </div>
                    <div class="single-clients">
                        <img src="{{ asset('assets/img/mediplus/client3.png') }}" alt="Client 3">
                    </div>
                    <div class="single-clients">
                        <img src="{{ asset('assets/img/mediplus/client4.png') }}" alt="Client 4">
                    </div>
                    <div class="single-clients">
                        <img src="{{ asset('assets/img/mediplus/client5.png') }}" alt="Client 5">
                    </div>
                    <div class="single-clients">
                        <img src="{{ asset('assets/img/mediplus/client1.png') }}" alt="Client 1">
                    </div>
			...
			<div class="container">
				...
				<div class="row">
					...
					<div class="col-lg-6 col-md-12 ">
						...
						<img src="{{ asset('assets/img/mediplus/contact-img.png') }}" alt="#">
						</div>
					</div>
				</div>
			</div>
